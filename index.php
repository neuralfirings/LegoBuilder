	...
	$(function() {
		...
		<script type="text/javascript">
			...
			function draw() {
				...
				var cube = new THREE.Mesh( new THREE.CubeGeometry(width, height, 10), new THREE.MeshLambertMaterial({color: 0xffffff}) );
				cube.position.x = .5 * spacing * (numHorizontal - 1);// - (size * .5 );
				cube.position.y = .5 * spacing * (numVertical - 1);//   - (size * .5 );
				cube.position.z = -1 * (10 * .5);
				...
				// Side 1
				var cube = new THREE.Mesh( new THREE.CubeGeometry(width, 10, thickness), new THREE.MeshLambertMaterial({color: 0xffffff}) );
				cube.position.x = .5 * spacing * (numHorizontal - 1);
				cube.position.y = .5 * spacing * (numVertical - 1) - height/2 + 5;
				cube.position.z = -1 * (10 * .5) - thickness/2;
				cube.overdraw = true;
				cubes.push(cube);
				scene.addObject(cube);
				...
				// Side 3
				var cube = new THREE.Mesh( new THREE.CubeGeometry(10, height, thickness), new THREE.MeshLambertMaterial({color: 0xffffff}) );
				cube.position.x = .5 * spacing * (numHorizontal - 1) - width/2 + 5;
				cube.position.y = .5 * spacing * (numVertical - 1);
				cube.position.z = -1 * (10 * .5) - thickness/2;
				cube.overdraw = true;
				cubes.push(cube);
				scene.addObject(cube);
